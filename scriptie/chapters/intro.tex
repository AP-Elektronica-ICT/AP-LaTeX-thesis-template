...
% \begin{description}
% \item[Motivation] \textit{Why do we care about the problem and the results? Importance of your work and the impact it might have if successful.}
% \item[Problem statement] \textit{What problem are you trying to solve? What is the scope of your work.}
% \item[Approach] \textit{How did you go about solving or making progress on the problem? }
% \item[Results] \textit{What's the answer? Specifically, is the solution faster, smaller, or otherwise better than something else.}
% \item[Conclusions] \textit{What are the implications of your answer? Is it going to change the world, be a nice hack, or simply serve as a road sign indicating that this path is a waste of time.}
% \end{description}
